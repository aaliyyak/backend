    ...
    <table class="table table-bordered mt-3">
        ...
        <tbody>
            @foreach ($fasilitas as $item)
                <tr>
                    <td><img src="{{ asset('storage/' . $item->gambar) }}" alt="Gambar" width="120"></td>
                    <td>{{ $item->nama }}</td>
...
<div class="d-flex justify-content-between align-items-center mt-3">
    <span style="color: gray; font-size: 14px;">Menampilkan   {{ $fasilitas->lastItem() }} hasil dari total {{ $fasilitas->total() }} data</span>
